	...
	return (
		<div className='flex flex-col gap-5'>
			...
			<div className='w-[80vw] grid grid-cols-1 md:grid-cols-2 px-10 gap-3'>
				...
				<div>
					<OnRampTransactions transactions={successTransactions} />
				</div>

				<div>
					<OnRampTransactions transactions={processingTransactions} />
				</div>

				<div>
					<OnRampTransactions transactions={failureTransactions} />
				</div>
			</div>
		</div>
	);
